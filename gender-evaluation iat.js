let task = {
   overallInstruction: ['<p><br />Welcome to the Gender-Evaluation Implicit Association Test.<br/><br/>In this task, You will be asked to sort words into groups as fast as you can while making as few mistakes as possible.<br /><br />This task takes about 10 minutes.<br /><br /></p>', "<br/>You will see words that represent<span style='color: #1fbd1f;' > competence</span>,<span style='color: #1fbd1f;' > personality</span>,<br/><span style='color: #42b0e0;' > Male Professor</span> and <span style='color: #42b0e0;' > Female Professor</span>.<br/>You will need to use E and I keys on your keyboard.<br /><br />When the word matches the label on the left side, press <strong>E</strong> key.<br />When the word matches the label on the right side, press <strong>I</strong> key.</div><div style='text-align: left; margin-left: 20px;'><br/><span style='color: #42b0e0;'>Male Professor:</span> Jack, John, Robert, Daniel, William<br/><span style='color: #42b0e0;'>Female Professor:</span> Julia, Emily, Alice, Sophie, Emma<br/><span style='color: #1fbd1f;'>Competence:</span> Accurate, Logical, Capable, Knowledgeable, Productive<br/><span style='color: #1fbd1f;'>Personality:</span> Emotional, Tender, Kind, Warm, Empathetic</div>"],
    reminderInstruction: ["<ul><li style='text-align: left;'>Place a left finger on the E key and a right finger on the I key on your keyboard.</li><li style='text-align: left;'>Press <strong>the E key with your left finger</strong> if the word fits the category on the left.</li><li style='text-align: left;'>Press <strong>the I key with your right finger</strong> if the word fits the category on the right.</li><li style='text-align: left;'>If you make a mistake, you will see an error message(<span style='color: red;' > X</span>), and please correct your answer by pressing the other key</li></ul>", "<div style='text-align: center;'><strong><br/>Keep in mind the following points</strong></div><ol><li style='text-align: left;'>Keep your fingers on the <strong>E and I keys</strong> to enable fast response.</li><li style='text-align: left;'>Two labels at the top will tell you which words go with each key.</li><li style='text-align: left;'>Each word has a correct classification. Most of these are easy.</li><li style='text-align: left;'><strong>Go as fast as possible</strong> while being accurate.</li><li style='text-align: left;'><strong>The instructions will change for each block</strong>, Please pay close attention!</li></ol>"],
  endingMessage: "<p style='color: darkgreen'><br /><br />You have completed this task. <br /><br />Thank you for your time.<br /><br /></p>",
    ...
    stimulusSources: {"p": ["Jack","John","Robert","William","Daniel"],"n": ["Julia","Emily","Alice","Sophie","Emma"],"+": ["Accurate","Logical","Competent","Knowledgeable","Productive"],"-": ["Emotional","Tender","Kind","Warm","Empathetic"]},
    ...
    blockConditions: [],
    studyName: 'Gender-Evaluation IAT',
...
function showOverallInstruction() {
    // This is the existing setup code for the instruction
    ...
    // After a timeout of 10 seconds, enable the continue button
    setTimeout(function() {
        actionButton.disabled = false;
    }, 5000); // 5000 milliseconds = 5 seconds

    // This is the existing logic to show the next page of instructions or move to the next phase
...
function generateBlockInstruction() {
    ...
    if (task.requiresCorrection) {
        words.push(" If you make a mistake, (the red <span style='color: red;'>X</span>) will appear, " + correctionResponseAction);
    }
    if (isMobile) {
