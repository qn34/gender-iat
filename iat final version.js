let task = {
   overallInstruction: ['<p><br />Welcome to the Professor-Evaluation Implicit Association Test.<br/><br/>In this task, You will be asked to sort words into groups<br/>as fast as you can while making as few mistakes as possible.<br /><br />This task takes about 5 minutes.<br /><br /></p>', "<br/>You will use the <strong>E</strong> and <strong>I</strong> computer keys to categorize items into groups as fast as you can.<br/><br/><br/><div style='text-align: left; margin-left: 20px;'>These are the four groups and the items that belong to each:</div></div><div style='text-align: left; margin-left: 20px;'><br/><span style='font-size: 22px;color: #42b0e0;'>Male Professor:</span><span style='font-size: 22px;'> Prof. Jack, Prof. John, Prof. Robert, Prof. Daniel, Prof. William</span><br/><span style='font-size: 22px;color: #42b0e0;'>Female Professor:</span><span style='font-size: 22px;'> Prof. Julia, Prof. Emily, Prof. Alice, Prof. Sophie, Prof. Emma</span><br/><span style='font-size: 22px;color: #1fbd1f;'>Competence:</span><span style='font-size: 22px;'> Accurate, Logical, Capable, Knowledgeable, Productive</span><br/><span style='font-size: 22px;color: #1fbd1f;'>Personality:</span><span style='font-size: 22px;'> Friendly, Tender, Kind, Warm, Empathetic</span></div>"],
    mobileOverallInstruction: ['<p>In this task, you will be presented with a set of words to classify into groups.<br /><br />The task requires that you classify the words as quickly as you can while making as few mistakes as possible.<br /><br />This task takes about 6 minutes.<br /><br /></p>', "<div>In this task, you'll need to tap the touch screen to answer the questions.<br /><br />When the word matches the label on the left side, tap the <strong>left</strong> button.<br /><br />When the word matches the label on the right side, tap the <strong>right</strong> button.</div>", "If you're using a mobile device, please hold your device vertically and scroll the page to ensure that the entire box is visible on the screen.<br /><br />Note: Don't pull down your page too fast, which may accidentally refresh the page and you'll lose your progress."],
      reminderInstruction: ["<ul><li style='text-align: left;'>Place a left finger on the E key and a right finger on the I key on your keyboard.</li><li style='text-align: left;'>Press <strong>the E key</strong> if the word belongs to the category on the left.</li><li style='text-align: left;'>Press <strong>the I key</strong> if the word belongs to the category on the right.</li><li style='text-align: left;'>If you make a mistake, you will see an error message(<span style='color: red;' > X </span>).<br/>If the red<span style='color: red;' > X</span> appears, please correct your answer by pressing the other key</li></ul>", "<div style='text-align: center;'><strong><br/>Keep in mind the following points</strong></div><ol><li style='text-align: left;'>Keep your fingers on the <strong>E and I keys</strong> to enable fast response.</li><li style='text-align: left;'>Two labels at the top will tell you which words go with each key.</li><li style='text-align: left;'>Each word has a correct classification. Most of these are easy.</li><li style='text-align: left;'><strong>Go as fast as possible</strong> while being accurate.</li><li style='text-align: left;'><strong>The instructions will change for each block</strong>, Please pay close attention!</li></ol>"],
    mobileReminderInstruction: ["<ul><li style='text-align: left;'>Place your device on a desk such that you can tap the screen with your index fingers very quickly.</li><li style='text-align: left;'>Press <strong>the left button with your left index finger</strong> if the word belongs to the category on the left.</li><li style='text-align: left;'>Press <strong>the right button with your right index finger</strong> if the word belongs to the category on the right.</li><li style='text-align: left;'>If you make a mistake, you will see an error message, and please correct your answer by pressing the other button</li></ul>", "<div style='text-align: center;'><strong>Keep in mind the following points</strong></div><ol><li style='text-align: left;'>Position your device properly to enable fast response.</li><li style='text-align: left;'>Two buttons at the bottom will tell you which words go with each button.</li><li style='text-align: left;'>Each word has a correct classification. Most of these are easy.</li><li style='text-align: left;'>The test gives no results if you go slow. Please try to <strong>go as fast as possible!</strong></li><li style='text-align: left;'><strong>Expect to make a few mistakes</strong> because of going fast. That's OKAY!</li></ol>"],
    endingMessage: "<p style='color: darkgreen'><br /><br />You have completed this task. <br /><br />Thank you for your time.<br /><br /></p>",
    stimulusLabels: {'p': 'Male professor', 'n': 'Female professor', '+': 'Competence', '-': 'Personality'},
    oppositeStimulusLabels: {'p': 'Female professor', 'n': 'Male professor', '+': 'Personality', '-': 'Competence'},
    stimulusSources: {"p": ["Prof. Jack","Prof. John","Prof. Robert","Prof. William","Prof. Daniel"],"n": ["Prof. Julia","Prof. Emily","Prof. Alice","Prof. Sophie","Prof. Emma"],"+": ["Accurate","Logical","Capable","Knowledgeable","Productive"],"-": ["Friendly","Tender","Kind","Warm","Empathetic"]
},
    attributeStimulusType: {'name': 'words', 'media': 'text'},
    targetStimulusType: {'name': 'words', 'media': 'text'},
    blockTrialNumbers: [20, 20, 20, 40, 30, 20, 40],
    leftKey: {'code': 'KeyE', 'name': 'E'},
    rightKey: {'code': 'KeyI', 'name': 'I'},
    advanceKey: {'code': 'Space', 'name': 'Space'},
    attributeLabelColor: '#0eb50e',
    attributeWordColor: '#0eb50e',
    targetLabelColor: '#3992d8',
    targetWordColor: '#3992d8',
    showExamples: false,
    exampleDisplayTime: 1500,
    exampleInstruction: ['<br /><br /><br /><p>The following is the list of category labels for this study: <strong>None</strong>, <strong>None</strong>, <strong>None</strong>, and <strong>None</strong>.<br /><br />You will now see examples for each category. The words will be presented, with the categories shown at the top of the screen.', '<br /><br /><br />Each word will be shown briefly.<br /><br />At this stage, you do not need to make any response.<br /><br />Just look at the word carefully.</p>'],
    interTrialInterval: 250,
    minimumAllowedReactionTime: 250,
    minimumPreloadImagePercent: 0,
    ...
    blockConditions: [],
    studyName: '',
    switchAttribute: true,
    counterBalancing: true,
    automaticResponsesDelay: 0.0
};
let boundingBox;
...
function generateBlockInstruction() {
    ...
    //add
     let words = [leftResponseAction, "for", leftLabelText,"<br />",
        rightResponseAction, "for", rightLabelText, "<br /> <br />",
        "Go as<span style='color: red;' > Fast</span> as you can while being accurate"+".","<br />",];
    if (task.requiresCorrection) {
        words.push(" If you make a mistake, the red <span style='color: red;'>X</span> will appear,<br/> " + "please "+correctionResponseAction+" to continue.");
    }
    if (isMobile) {
...
function updateSingleLabelText(label, text, forAttribute, alignment) {
	label.innerHTML = "<span style='color: " + (forAttribute ? task.attributeLabelColor : task.targetLabelColor) + "'>" + text + "</span>";
    label.style.textAlign = alignment;
    label.style.maxWidth = "50%";
    label.style.display = "inline-block"; // Treats the label as an inline element with block behaviors
	label.style.whiteSpace = "nowrap"; // Prevent line wrapping
