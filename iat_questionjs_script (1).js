let task = {
    overallInstruction: ['<p>In this task, you will be presented with a set of words to classify into groups.<br /><br />The task requires that you classify the words as quickly as you can while making as few mistakes as possible.<br /><br />This task takes about 6 minutes.<br /><br /></p>', "<div>In this task, you'll need to press E and I keys on your keyboard to answer the questions.</div><div><br />When the word matches the label on the left side, press <strong>E</strong> key.<br /><br />When the word matches the label on the right side, press <strong>I</strong> key.</div>"],
